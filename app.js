...
Alpine.data('signatureApp', () => ({
    ...
    // Firebase 의존성 변수 (초기화 단계에서 객체 저장용)
    appId: null,
    userId: null,
    db: null,
    isSyncing: false,
    ...
    async init() {
        ...
        this.initDragScroll(); 
        await this.initFirebase(); // 비동기 Firebase 초기화를 안전하게 대기
    },
...
// 모든 설정이 완료된 후 Alpine 실행 (가장 중요한 부분)
Alpine.start();
